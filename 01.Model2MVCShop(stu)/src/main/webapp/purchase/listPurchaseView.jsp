   ...
   %>
	...
	<tr class="ct_list_pop">
		...
		<td align="left">
    	  ...
    	  현재 배송중 상태입니다. <a href="/updateTranCode.do?prodNo=<%=vo.getPurchaseProd().getProdNo()%>&tranCode=3">물건도착</a>
    	  <% } %>
    	  <% if(vo.getTranCode().trim().equals("3")){ %>
    	 현재 배송완료 상태입니다. 
    	  <% } %>
		...
		<td align="left">
		 <% if(vo.getTranCode().trim().equals("2")){ %>
		<a href="/updateTranCode.do?prodNo=<%=vo.getPurchaseProd().getProdNo()%>&tranCode=3">
		물건도착
