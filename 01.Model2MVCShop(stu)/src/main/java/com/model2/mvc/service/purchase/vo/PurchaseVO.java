...
public class PurchaseVO {
	...
	private UserVO buyer;// uservo타입의 구매자 정보 userid
	private String divyAddr; //string 타입의 배송지 주소 
	private String divyDate; //string 타입의 배송희망날짜 
	private String divyRequest; //string타입의 배송시 요구사항
	private Date orderDate; // java.sql.date 타입의 구매일자 
	private String paymentOption; // string 타입의 지불방식
	private ProductVO purchaseProd; // product타입의 구매물품 정보 prodno
	private String receiverName; // string타입의 받는 사람 이름 
	private String receiverPhone; // string타입의 받는 사람 전화번호 
	private String tranCode; // string타입의 구매 상태코드 
	private int tranNo; // int 타입의 구매번호 
